...
MODULE DEFINE_INPUT_TYPES
    ...
    TYPE :: PL_DS_TYPE
        ...
        INTEGER, PRIVATE :: VARID_SPECIES_EMI_MASS = -1
...
CONTAINS
    ...
    SUBROUTINE FL_INIT(FL_DS, FILEPATH)
        ...
        ! STATUS = NF90_INQ_VARID(FL_DS%FL_NCID, "time", FL_DS%VARID_TIME)
    ...
    SUBROUTINE PL_INIT(PL_DS, FILEPATH)
        ...
        STATUS = NF90_INQ_VARID(PL_DS%PL_NCID, "species_emi_mass", PL_DS%VARID_SPECIES_EMI_MASS)
        CALL NC_CHECK(STATUS, "NF90_INQ_VARID(species_emi_mass)")
    ...
    SUBROUTINE PL_READ_STATIC(PL_DS)
        ...
        IF (.NOT. ALLOCATED(PL_DS%SPECIES_EMI_MASS)) ALLOCATE(PL_DS%SPECIES_EMI_MASS(PL_DS%NSEG, PL_DS%NSEMI))
        ...
        STATUS = NF90_GET_VAR(PL_DS%PL_NCID, PL_DS%VARID_SPECIES_EMI_MASS, PL_DS%SPECIES_EMI_MASS, &
                              START=[1, 1], COUNT=[PL_DS%NSEMI, PL_DS%NSEG])
        CALL NC_CHECK(STATUS, "NF90_GET_VAR(species_emi_mass)")
    ...
    SUBROUTINE PL_CLOSE(PL_DS)
        ...
        PL_DS%VARID_SPECIES_EMI_MASS = -1       
    ...
    SUBROUTINE BOXM_INIT(BOXM_DS, FILEPATH)
        ...
        STATUS = NF90_INQ_VARID(BOXM_DS%BOXM_NCID, "bg_chem", BOXM_DS%VARID_Y_BG_C)
        CALL NC_CHECK(STATUS, "NF90_INQ_VARID(bg_chem)")
    ...
    SUBROUTINE BOXM_READ_STATIC(BOXM_DS)
        ...
        CALL NC_CHECK(STATUS, "NF90_GET_VAR(bg_chem)")
...
MODULE DEFINE_OUTPUT_TYPES
    ...
    TYPE :: PL_OUT_TYPE
        ...
        INTEGER, PRIVATE :: DIMID_SEG_ID = -1
        INTEGER, PRIVATE :: DIMID_TIME = -1
        INTEGER, PRIVATE :: DIMID_SPECIES_PLUME = -1
        ! PL_OUT VAR IDs
        INTEGER, PRIVATE :: VARID_SPECIES_PLUME_MASS = -1
...
CONTAINS
    ...
    SUBROUTINE PL_OUT_INIT(PL_OUT, FILEPATH)
        ...
        STATUS = NF90_INQ_DIMID(PL_OUT%PL_OUT_NCID, "species_plume", PL_OUT%DIMID_SPECIES_PLUME)
        CALL NC_CHECK(STATUS, "NF90_INQ_DIMID(species_plume)")

        STATUS = NF90_INQUIRE_DIMENSION(PL_OUT%PL_OUT_NCID, PL_OUT%DIMID_SPECIES_PLUME, LEN=PL_OUT%NSPL)
        CALL NC_CHECK(STATUS, "NF90_INQUIRE_DIMENSION(species_plume)")

        STATUS = NF90_INQ_DIMID(PL_OUT%PL_OUT_NCID, "time", PL_OUT%DIMID_TIME)
        CALL NC_CHECK(STATUS, "NF90_INQ_DIMID(time)")

        STATUS = NF90_INQUIRE_DIMENSION(PL_OUT%PL_OUT_NCID, PL_OUT%DIMID_TIME, LEN=PL_OUT%NTPL)
        CALL NC_CHECK(STATUS, "NF90_INQUIRE_DIMENSION(time)")

        ! VAR IDS
        STATUS = NF90_INQ_VARID(PL_OUT%PL_OUT_NCID, "species_plume_num", PL_OUT%VARID_SPECIES_PLUME_NUM)
        CALL NC_CHECK(STATUS, "NF90_INQ_VARID(species_plume_num)")

        STATUS = NF90_INQ_VARID(PL_OUT%PL_OUT_NCID, "species_plume_mass", PL_OUT%VARID_SPECIES_PLUME_MASS)
        CALL NC_CHECK(STATUS, "NF90_INQ_VARID(species_plume_mass)")
    ...
    SUBROUTINE PL_OUT_READ_STATIC(PL_OUT)
        ...
        IF (PL_OUT%NTPL <= 0) STOP "PL_OUT_READ_STATIC: NTPL NOT SET"

        IF (.NOT. ALLOCATED(PL_OUT%SPECIES_PLUME_NUM)) ALLOCATE(PL_OUT%SPECIES_PLUME_NUM(PL_OUT%NSPL))
        IF (.NOT. ALLOCATED(PL_OUT%SPECIES_PLUME_MASS)) ALLOCATE(PL_OUT%SPECIES_PLUME_MASS(PL_OUT%NSEG, PL_OUT%NSPL, PL_OUT%NTPL))
    ...
    SUBROUTINE PL_OUT_WRITE(PL_OUT, PL_STATE)
        ...
        IF (PL_OUT%NTPL <= 0) STOP "PL_OUT_WRITE: NTPL NOT SET"

        ! WRITE PL OUT VARS
        ! STATUS = NF90_PUT_VAR(PL_OUT%PL_OUT_NCID, PL_OUT%VARID_SPECIES_PLUME_MASS, PL_STATE%SPECIES_PLUME_MASS, &
        !                       START=[1, 1, 1], COUNT=[PL_OUT%NSEG, PL_OUT%NSPL, PL_OUT%NTPL])
        ! CALL NC_CHECK(STATUS, "NF90_PUT_VAR(species_plume_mass)")
    ...
    SUBROUTINE BOXM_OUT_WRITE(BOXM_OUT, BOXM_STATE)
        ...
        ! WRITE BOXM OUT VARS
        ! STATUS = NF90_PUT_VAR(BOXM_OUT%BOXM_OUT_NCID, BOXM_OUT%VARID_Y_BG_C, BOXM_OUT%Y_BG_C, &
        !                       START=[1, 1, 1], COUNT=[BOXM_OUT%NCELL, BOXM_OUT%NSOUT, BOXM_OUT%NTOUT])
        ! CALL NC_CHECK(STATUS, "NF90_PUT_VAR(y_bg_c)")

        ! STATUS = NF90_PUT_VAR(BOXM_OUT%BOXM_OUT_NCID, BOXM_OUT%VARID_Y_DEL_C, BOXM_OUT%Y_DEL_C, &
        !                       START=[1, 1, 1], COUNT=[BOXM_OUT%NCELL, BOXM_OUT%NSOUT, BOXM_OUT%NTOUT])
        ! CALL NC_CHECK(STATUS, "NF90_PUT_VAR(y_del_c)")

        ! STATUS = NF90_PUT_VAR(BOXM_OUT%BOXM_OUT_NCID, BOXM_OUT%VARID_ACTIVE_FLAG, BOXM_OUT%ACTIVE_FLAG, &
        !                       START=[1, 1], COUNT=[BOXM_OUT%NCELL, BOXM_OUT%NTOUT])
    ...
    SUBROUTINE PATCH_TABLE_WRITE(PATCH_TABLE, PATCH_STATE)
        ...
        IF (PATCH_TABLE%NROWS <= 0) STOP "PATCH_TABLE_WRITE: NROWS NOT SET"
        IF (PATCH_TABLE%NSOUT <= 0) STOP "PATCH_TABLE_WRITE: NSOUT NOT SET"

        ! WRITE PATCH TABLE VARS
        ! STATUS = NF90_PUT_VAR(PATCH_TABLE%PATCH_TABLE_NCID, PATCH_TABLE%VARID_Y_DEL_F, PATCH_TABLE%Y_DEL_F, &
        !                       START=[1, 1], COUNT=[PATCH_TABLE%NROWS, PATCH_TABLE%NSOUT])
...
!         IERR = NF90_INQ_DIMLEN(FL_NCID, DIMID_TIME, LEN=NTS)
...
!         IERR = NF90_INQ_DIMLEN(FL_NCID, DIMID_WAYPOINT, LEN=NWAYPOINT)
...
!         CALL CHECK(IERR, 'ERROR: CANNOT GET FLIGHT_ID DIMID')
!         IERR = NF90_INQ_DIMLEN(PL_NCID, DIMID_TIME, LEN=NTS)
!         CALL CHECK(IERR, 'ERROR: CANNOT GET FLIGHT_ID LENGTH')

!         IERR = NF90_INQ_DIMID(PL_NCID, 'waypoint', DIMID_WAYPOINT)
!         CALL CHECK(IERR, 'ERROR: CANNOT GET WAYPOINT DIMID')
!         IERR = NF90_INQ_DIMLEN(PL_NCID, DIMID_WAYPOINT, LEN=NWAYPOINT)
!         CALL CHECK(IERR, 'ERROR: CANNOT GET WAYPOINT LENGTH')
...
!         IERR = NF90_INQ_DIMLEN(PL_NCID, DIMID_CELL, LEN=NCELL)
...
!         CALL CHECK(IERR, 'ERROR: CANNOT GET TIME DIMID')
!         IERR = NF90_INQ_DIMLEN(BOXM_NCID, DIMID_TIME, LEN=NTS)
!         CALL CHECK(IERR, 'ERROR: CANNOT GET TIME LENGTH')

!         IERR = NF90_INQ_DIMID(BOXM_NCID, 'cell', DIMID_CELL)
!         CALL CHECK(IERR, 'ERROR: CANNOT GET CELL DIMID')
!         IERR = NF90_INQ_DIMLEN(BOXM_NCID, DIMID_CELL, LEN=NCELL)
...
!         IERR = NF90_INQ_DIMLEN(BOXM_NCID, DIMID_NS, LEN=NS)
