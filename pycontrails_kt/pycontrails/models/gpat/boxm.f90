MODULE DEFINE_TYPES
    ...
    TYPE :: PL_OUT_TYPE
        ...
        ! PL_OUT VAR IDs
        INTEGER, PRIVATE :: DIMID_FL_ID = -1
        INTEGER, PRIVATE :: DIMID_WP = -1
...
CONTAINS
    ...
    SUBROUTINE FL_READ_STATIC(FL_DS)
        ...
        IF (.NOT. ALLOCATED(FL_DS%TIME)) ALLOCATE(FL_DS%TIME(FL_DS%NSEG))
