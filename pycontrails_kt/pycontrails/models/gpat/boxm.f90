...
CONTAINS
    ...
    SUBROUTINE PL_OUT_WRITE(PL_OUT)
        CLASS(PL_OUT_TYPE), INTENT(INOUT) :: PL_OUT
        INTEGER :: STATUS
        ...
        ! WRITE PL OUT VARS
        ! STATUS = NF90_PUT_VAR(PL_OUT%PL_OUT_NCID, PL_OUT%VARID_SPECIES_PLUME_MASS, PL_OUT%SPECIES_PLUME_MASS, &
    ...
    SUBROUTINE BOXM_OUT_WRITE(BOXM_OUT)
        CLASS(BOXM_OUT_TYPE), INTENT(INOUT) :: BOXM_OUT
        INTEGER :: STATUS
