MODULE DEFINE_TYPES
    ...
    TYPE :: BOXM_DS_TYPE
        ...
        INTEGER :: DIMID_SPECIES_BOXM = -1
        INTEGER :: DIMID_TIME = -1
        
        ! BOXM VAR IDs
        INTEGER :: VARID_TIME_REL_S = -1
        INTEGER :: VARID_TIME_IDX = -1
        INTEGER :: VARID_LONGITUDE_C = -1
        INTEGER :: VARID_LATITUDE_C = -1
        INTEGER :: VARID_ALTITUDE_C = -1
        INTEGER :: VARID_LEVEL_C = -1

        INTEGER :: VARID_TEMP = -1
        INTEGER :: VARID_H2O = -1
        INTEGER :: VARID_M = -1
        INTEGER :: VARID_O2 = -1
        INTEGER :: VARID_N2 = -1
    ...
    TYPE :: PL_STATE_TYPE
        ...
        REAL(DP), ALLOCATABLE :: SPECIES_PLUME_MASS(:,:)      ! (NSEG, NSPL) kg
    ...
    TYPE :: BOXM_STATE_TYPE
        ...
        REAL(DP), ALLOCATABLE :: Y_BG(:,:)    ! (NCELL, NSBOXM) mol/m3
