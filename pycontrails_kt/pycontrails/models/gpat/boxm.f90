...
CONTAINS
    ...
    SUBROUTINE PL_STATE_ADVANCE_GEOM(PL_STATE, PL_SLICES, PL_DS, TIME_IDX)
        ...
        INTEGER :: SEG_ID, HT, SLICE, PL_I, I
    ...
    SUBROUTINE PL_STATE_ADVANCE_MASS(PL_STATE, PL_SLICES, FL_DS, PL_DS, TIME_IDX)
        CLASS(PL_STATE_TYPE),    INTENT(INOUT) :: PL_STATE
        CLASS(PL_SLICES_TYPE),   INTENT(INOUT) :: PL_SLICES
        CLASS(FL_DS_TYPE),       INTENT(IN)    :: FL_DS
        CLASS(PL_DS_TYPE),       INTENT(IN)    :: PL_DS

        INTEGER :: SEG_ID, SLICE, SPECIES_ID, TIME_IDX, I, STATE_I, EMI_ID, PL_ID
        REAL(DP) :: MASS_SEG
...
CONTAINS
    ...
    SUBROUTINE PL_OUT_WRITE(PL_OUT, PL_STATE, PL_DS, TIME_IDX)
        ...
        INTEGER, INTENT(IN) :: TIME_IDX
        INTEGER :: STATUS, PL_I, OUT_I, I, NDIMS, DLEN, SPECIES_ID
        INTEGER :: DIMID_TIME, DIMID_SPECIES_PL, DIMID_SEG_ID
        CHARACTER(LEN=NF90_MAX_NAME) :: DNAME
        REAL(DP) :: STATE_SUM, RB_SUM, RB_MIN, RB_MAX
        REAL(DP), ALLOCATABLE :: PL_MASS_READBACK(:,:,:)
...
CONTAINS
    ...
    SUBROUTINE PROJECT_PLUMES_TO_GRID(FL_DS, PL_DS, BOXM_DS, PL_STATE, PL_SLICES, BOXM_STATE, PATCH_STATE, TIME_IDX)
        USE DEFINE_INPUT_TYPES
        USE DEFINE_STATE_TYPES
        IMPLICIT NONE
        ...
        CALL PL_STATE%ADVANCE_MASS(PL_SLICES, FL_DS, PL_DS, TIME_IDX)
...
PROGRAM BOXM_RUN
    ...
    DO TIME_IDX = 1, BOXM_DS%NTBOXM
        ...
        CALL PROJECT_PLUMES_TO_GRID(FL_DS, PL_DS, BOXM_DS, PL_STATE, PL_SLICES, BOXM_STATE, PATCH_STATE, TIME_IDX)
