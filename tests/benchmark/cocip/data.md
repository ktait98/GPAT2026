...
All [Cocip parameters set to defaults](https://py.contrails.earth/api/pycontrails.models.cocip.CocipParams.html#pycontrails.models.cocip.CocipParams) except as overridden in [benchmark.py](pycontrails-legacy/tests/benchmark/cocip/benchmark.py).
