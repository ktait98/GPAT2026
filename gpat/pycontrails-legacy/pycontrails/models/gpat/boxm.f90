...
CONTAINS
    ...
    SUBROUTINE PL_STATE_BACKPROJECT_FROM_GRID(PL_STATE, PL_DS, BOXM_DS, BOXM_STATE, PATCH_STATE, TIME_IDX)
        ...
        DO SEG_ID = 1, PL_STATE%NSEG
            IF (.NOT. SEG_HAS_MAP(SEG_ID)) CYCLE
...
CONTAINS
    ...
    SUBROUTINE RUN_CHEM(PL_DS, BOXM_DS, BOXM_STATE, PATCH_STATE, TIME_IDX)
        USE DEFINE_INPUT_TYPES
        USE DEFINE_STATE_TYPES
        USE RUN_CHEM_UTILS
...
PROGRAM BOXM_RUN
    ...
    DO TIME_IDX = 1, BOXM_DS%NTBOXM
        ...
        ! WRITE OUTPUTS at the START of each output interval, before running chemistry.
