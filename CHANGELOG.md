...
- Update links in the [README](pycontrails-legacy/README.md).
- Update the [release guide](pycontrails-legacy/RELEASE.md) to include a checklist of steps to follow when cutting a release.
